def get_distrokid_prompt(description, style_preset):
    style_map = {
        "Spiritual": "Cinematic lighting, serene, ethereal, soft golden hour, 8k.",
    ...
    return f"Create a 3000x3000px square cover art. Scene: {description}. Style: {refined_style}. NO TEXT."
...
def get_thumbnail_prompt(description, text, style_preset):
    style_map = {
        ...
        "Oil Painting": "Classical oil painting style, 4k."
    }
    refined_style = style_map.get(style_preset, "High-quality YouTube thumbnail, 4k.")
    return f"Create a high-CTR YouTube thumbnail. Scene: {description}. Text Overlay: '{text}'. Style: {refined_style}. Bold clear text."